...
def maak_kaart():
    """Maak een veel grotere kaart met minder kamers en meer open ruimte."""
    breedte = 129
    hoogte = 63
    kaart = []
    ...
    for rij in range(8, 25):
        kaart[rij][20] = "#"
    for rij in range(38, 56):
        kaart[rij][107] = "#"
    for kolom in range(58, 76):
        kaart[18][kolom] = "#"
    for kolom in range(53, 71):
        kaart[48][kolom] = "#"
