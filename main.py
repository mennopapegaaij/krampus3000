...
class Krampus3000Spel:
    ...
    def maak_krampus(self):
        ...
        hoorn_kleur = kleur(210, 192, 168)
        hoorn_schaduw = kleur(168, 132, 102)
        hoorn_rood = kleur(138, 28, 30)
        ...
        self.krampus_hoorn_links_onder = Entity(
            parent=self.krampus,
            model="cube",
            position=(-0.3, 3.12, 0.12),
            rotation=(12, -4, 18),
            scale=(0.22, 0.72, 0.22),
            color=hoorn_schaduw,
        )
        self.krampus_hoorn_links_wortel = Entity(
            parent=self.krampus,
            model="cube",
            position=(-0.38, 3.34, 0.06),
            rotation=(18, -8, 28),
            scale=(0.2, 0.58, 0.2),
            color=hoorn_schaduw,
        )
        ...
        self.krampus_hoorn_links_boven = Entity(
            parent=self.krampus,
            model="cube",
            position=(-0.8, 4.16, -0.34),
            rotation=(54, -28, 78),
            scale=(0.13, 0.5, 0.13),
            color=hoorn_kleur,
        )
        self.krampus_hoorn_links_topbocht = Entity(
            parent=self.krampus,
            model="cube",
            position=(-0.88, 4.34, -0.48),
            rotation=(62, -30, 90),
            scale=(0.1, 0.34, 0.1),
            color=hoorn_kleur,
        )
        ...
        self.krampus_hoorn_links_rood = Entity(
            parent=self.krampus,
            model="cube",
            position=(-0.62, 3.72, -0.12),
            rotation=(36, -20, 58),
            scale=(0.19, 0.12, 0.19),
            color=hoorn_rood,
        )
        self.krampus_hoorn_links_rood_boven = Entity(
            parent=self.krampus,
            model="cube",
            position=(-0.82, 4.24, -0.4),
            rotation=(58, -28, 84),
            scale=(0.14, 0.1, 0.14),
            color=hoorn_rood,
        )
        ...
        self.krampus_hoorn_rechts_wortel = Entity(
            parent=self.krampus,
            model="cube",
            position=(0.38, 3.34, 0.06),
            rotation=(18, 8, -28),
        ...
        self.krampus_hoorn_rechts_topbocht = Entity(
            parent=self.krampus,
            model="cube",
            position=(0.88, 4.34, -0.48),
            rotation=(62, 30, -90),
        ...
        self.krampus_hoorn_rechts_rood_boven = Entity(
            parent=self.krampus,
            model="cube",
            position=(0.82, 4.24, -0.4),
            rotation=(58, 28, -84),
